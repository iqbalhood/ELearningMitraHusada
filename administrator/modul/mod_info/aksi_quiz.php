...
if ($module=='info' AND $act=='input_topikquiz'){
    ...
    mysql_query("INSERT INTO info_pengumuman(
                                    judul,
                                    id_kelas,
                                    id_matapelajaran,
                                    tgl_buat,
...
elseif($module=='info' AND $act=='edit_topikquiz'){
    $pelajaran = mysql_query("SELECT * FROM mata_pelajaran WHERE id_matapelajaran = '$_POST[id_matapelajaran]'");
    $data = mysql_fetch_array($pelajaran);
    $pengajar = mysql_query("SELECT * FROM pengajar WHERE id_pengajar = '$data[id_pengajar]'");
    $cek_pengajar_pelajaran = mysql_num_rows($pengajar);
    ...
    mysql_query("UPDATE info_pengumuman SET judul = '$_POST[judul]',
...
elseif($module=='info' AND $act=='hapustopikquiz'){
    //hapus topik
  mysql_query("DELETE FROM info_pengumuman WHERE id_info = '$_GET[id]'");
  //hapus kuiz esay
