    ...
    <input type=button class='button blue' value=Kembali onclick=self.history.back()>";
            ...
            window.location=(href='?module=kelas')</script>";
                ...
                if (!empty($cek_siswa)) {
                    ...
                    echo "<table>
          <tr><th>No</th><th>NPM</th><th>Nama Mahasiswa</th><th>Jenis Kelamin</th><th>Th Masuk</th>
           <th>Aksi</th></tr>";
                    $no = 1;
                    while ($r = mysql_fetch_array($tampil)) {
                        echo "<tr><td>$no</td>
        ...
        case "tambahsiswa":
          ...
          <dl class='inline'>
          <dt><label>NPM</label></dt>          <dd> : <input type=text name='nis'></dd>
        ...
        case "nis_ada":
            if ($_SESSION[leveluser] == 'admin') {
                echo "<span class='judulhead'><p class='garisbawah'>NPM SUDAH PERNAH DIGUNAKAN<br>
        ...
        case "editsiswa":
          ...
          <dl class='inline'>
          <dt><label>NPM</label></dt>     <dd> : <input type=text name=nis value='$r[nis]'></dd>
          ...
          <input type=hidden name=id value='$r[id_siswa]'>
          <table>
          <tr><td>NPM</td>     <td> : <input type=text name=nis value='$r[nis]' ></td></tr>
        ...
        case "detailsiswa":
          ...
          <dl class='inline'>
          <dt><label>NPM</label></dt>        <dd> : $siswa[nis]</dd>
       ...
       <table id='table1' class='gtable sortable'>
          <tr><td rowspan='15'>";
                ...
                echo "</td><td>NPM</td>        <td> : $siswa[nis]</td></tr>
